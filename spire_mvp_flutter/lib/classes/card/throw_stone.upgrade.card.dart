...
class ThrowStoneUpgradeCard extends PlayableCard {
  int damage = 5;

  ThrowStoneUpgradeCard(
      {cardName = 'Throw Stone+',
      cardDescription = '0 mana, 90% precision, 5 damage',
      cardMana = 0,
      cardTemporary = false})
      : super(
            cardName: cardName,
  ...
  StatelessWidget getCardName(BuildContext context) {
    return Text(
      AppLocalizations.of(context)!.throwStoneCardUpgradeName,
