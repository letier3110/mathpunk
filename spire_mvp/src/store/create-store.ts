...
import { gameStateReducers } from './game-state/game-state.reducers';
import { GameStateRootState } from './game-state/game-state.state';
import { rootStateReducer } from './root-state.reducer';

export type RootState = GameStateRootState;
