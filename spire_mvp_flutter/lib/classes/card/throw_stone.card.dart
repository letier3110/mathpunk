...
import 'package:mathpunk_cardgame/classes/card/throw_stone.upgrade.card.dart';
...
class ThrowStoneCard extends PlayableCard {
  int damage = 3;
  ...
  ThrowStoneCard(
      ...
      : super(
            ...
            cardUpgrageLink: ThrowStoneUpgradeCard(),
            cardPrecision: 70);
